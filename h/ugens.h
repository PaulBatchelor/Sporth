...
SPORTH_UGEN("c", sporth_constant, SPORTH_CONSTANT, 2, 1)
...
SPORTH_UGEN("ling", sporth_ling, SPORTH_LING, 4, 1)
SPORTH_UGEN("ladspa", sporth_ladspa, SPORTH_LADSPA, 3, 0)
...
SPORTH_UGEN("maygate", sporth_maygate, SPORTH_MAYGATE, 3, 1)
SPORTH_UGEN("maytrig", sporth_maytrig, SPORTH_MAYTRIG, 2, 1)
SPORTH_UGEN("metro", sporth_metro, SPORTH_METRO, 2, 1)
...
SPORTH_UGEN("nsmp", sporth_nsmp, SPORTH_NSMP, 4, 1)
...
SPORTH_UGEN("print", sporth_print, SPORTH_PRINT, 2, 1)
...
SPORTH_UGEN("randi", sporth_randi, SPORTH_RANDI, 4, 1)
